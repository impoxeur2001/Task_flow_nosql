...
public class TacheService implements ITacheService{
   ...
   ProjetRepository pr;
    ...
    @Override
    public Tache creerTache( Integer id,String titre, Date deadLine, Utilisateur responsable, Projet projet, List<Date> breakPoints) {
        Tache tache =new Tache(id,deadLine, titre, responsable, projet,breakPoints );
        tr.save(tache);
        return  tache;
    }
    ...
    @Override
    public Commentaire creerCommentaire(Integer id,String contenu, Utilisateur auteur) {
        Commentaire commentaire=new Commentaire(id,contenu,auteur);
        cr.save(commentaire);
        return commentaire;
    }
}
