...
public class UtilisateurController {
    ...
    public ResponseEntity createNewUser(@RequestBody Utilisateur utilisateur) {
        ...
        Integer id =sequenceGeneratorService.generateSequence(Utilisateur.SEQUENCE_NAME);
       Utilisateur user= us.creerUtilisateur(id,utilisateur.getNom(), utilisateur.getEmail());
