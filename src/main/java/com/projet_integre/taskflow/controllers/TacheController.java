...
import com.projet_integre.taskflow.services.SequenceGeneratorService;
...
public class TacheController {
    ...
    public ResponseEntity creerTache(@RequestBody Map<String, String>  newTask ) throws ParseException {
        ...
        Tache tache= ts.creerTache(id,newTask.get("titre"), date, responsable,projet );
        HashMap<String, Tache> response = new HashMap<>();
        response.put("tache",tache);
    ...
    public ResponseEntity commenterTache(@RequestBody Map<String, String> info ) throws ParseException {
        ...
        Integer id= sequenceGeneratorService.generateSequence(Commentaire.SEQUENCE_NAME);
        Commentaire commentaire= ts.creerCommentaire(id,info.get("text"), auteur);
